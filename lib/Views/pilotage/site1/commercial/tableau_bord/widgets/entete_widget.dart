...
import 'package:perfqse/Views/pilotage/site1/commercial/tableau_bord/widgets/processus.dart';
...
class _EntityWidgetWidgetState extends State<EnteteTableauBord> {
  ...
  final Location="/pilotage/Site1/Com/tableau-de-bord/transite-tableau-bord/indicateurs";
  ...
  Future<void> _openCritereFilterDialog() async {
    ...
    height: 500,
      routeSettings:RouteSettings(
        name: "/pilotage/espace/Com/tableau-de-bord/indicateurs",
      ),
    listData:DataCrit,
