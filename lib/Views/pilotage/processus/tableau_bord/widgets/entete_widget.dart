...
import 'package:perfqse/Views/pilotage/processus/tableau_bord/widgets/processus.dart';
...
class _EntityWidgetWidgetState extends State<EnteteTableauBord> {
  ...
  final Location="/pilotage/$Site/$Processus/tableau-de-bord/indicateurs";
                      ...
                      return [
                        PopupMenuItem(
                          onTap: ()async{
                            ...
                            final storage=FlutterSecureStorage();
                            final String? espace = Processus; //await storage.read(key:"espace");
                        ...
                        PopupMenuItem(
                          onTap: () async {
                            ...
                            try{
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(showSnackBar("Erreur"
                                  ,"Un Problème est survenue lors du chargement des données", Colors.red));
                            }
                            },
                          child:Text("${year-1}")),
                        PopupMenuItem(
  ...
  Future<void> _openCritereFilterDialog() async {
    ...
    height: 500,
      routeSettings:RouteSettings(
        name: "/pilotage/$Site/$Processus/tableau-de-bord/indicateurs",
      ),
    listData:DataCrit,
