    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text("Processus",style: TextStyle(fontSize: 18,color:Colors.red,fontWeight: FontWeight.bold),),
          SizedBox(
            width: //responsive == "cas-0" ? 10 :
            20,
          ),
          responsive == "cas-0" ? Text("$Processus",style: TextStyle(fontSize: 18),) :
          const EntityWidget(),
          ...
          InkWell(
            onTap: (){
              context.go("/pilotage/$Site/$Processus/profil");
            },
            radius: 20,
