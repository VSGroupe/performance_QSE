...
class AppBarAccueilpilotage extends StatefulWidget {

  const AppBarAccueilpilotage({Key? key}) : super(key: key);

  @override
  State<AppBarAccueilpilotage> createState() => _AppBarAccueilpilotageState();
}

class _AppBarAccueilpilotageState extends State<AppBarAccueilpilotage> {
          ...
          Row(
            children: [
              ...
              RichText(text:TextSpan(
                  text:"Accueil ",style: TextStyle(fontSize: 25,color:Colors.white,fontWeight: FontWeight.bold),
                  children: [
                    TextSpan(text:" PILOTAGE ",style: TextStyle(fontSize: 25,color:Color.fromRGBO(42,77,4,1),fontWeight: FontWeight.bold),),
                  ]
              ),
              )
            ],
