...
class HeaderCardOverviewEvaluationE extends StatefulWidget {
  final String? title;
  final double? width;
  ...
  const HeaderCardOverviewEvaluationE({super.key,this.width,required this.title, this.dataMap, this.legendLabels, this.listColorLegends, this.chartType, this.legendPosition, required this.typeChart,});

  @override
  State<HeaderCardOverviewEvaluationE> createState() => _HeaderCardOverviewEvaluationEState();
}

class _HeaderCardOverviewEvaluationEState extends State<HeaderCardOverviewEvaluationE> {
