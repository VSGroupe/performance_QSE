...
class HeaderCardOverviewEvaluationQ extends StatefulWidget {
  final String? title;
  final double? width;
  ...
  const HeaderCardOverviewEvaluationQ({super.key,this.width,required this.title, this.dataMap, this.legendLabels, this.listColorLegends, this.chartType, this.legendPosition, required this.typeChart,});

  @override
  State<HeaderCardOverviewEvaluationQ> createState() => _HeaderCardOverviewEvaluationQState();
}

class _HeaderCardOverviewEvaluationQState extends State<HeaderCardOverviewEvaluationQ> {
