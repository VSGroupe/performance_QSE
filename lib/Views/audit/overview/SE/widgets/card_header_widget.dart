...
class HeaderCardOverviewEvaluationSE extends StatefulWidget {
  final String? title;
  final double? width;
  ...
  const HeaderCardOverviewEvaluationSE({super.key,this.width,required this.title, this.dataMap, this.legendLabels, this.listColorLegends, this.chartType, this.legendPosition, required this.typeChart,});

  @override
  State<HeaderCardOverviewEvaluationSE> createState() => _HeaderCardOverviewEvaluationSEState();
}

class _HeaderCardOverviewEvaluationSEState extends State<HeaderCardOverviewEvaluationSE> {
