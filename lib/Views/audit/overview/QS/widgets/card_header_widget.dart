...
class HeaderCardOverviewEvaluationQS extends StatefulWidget {
  final String? title;
  final double? width;
  ...
  const HeaderCardOverviewEvaluationQS({super.key,this.width,required this.title, this.dataMap, this.legendLabels, this.listColorLegends, this.chartType, this.legendPosition, required this.typeChart,});

  @override
  State<HeaderCardOverviewEvaluationQS> createState() => _HeaderCardOverviewEvaluationQSState();
}

class _HeaderCardOverviewEvaluationQSState extends State<HeaderCardOverviewEvaluationQS> {
