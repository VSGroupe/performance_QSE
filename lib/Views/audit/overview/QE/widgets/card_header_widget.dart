...
class HeaderCardOverviewEvaluationQE extends StatefulWidget {
  final String? title;
  final double? width;
  ...
  const HeaderCardOverviewEvaluationQE({super.key,this.width,required this.title, this.dataMap, this.legendLabels, this.listColorLegends, this.chartType, this.legendPosition, required this.typeChart,});

  @override
  State<HeaderCardOverviewEvaluationQE> createState() => _HeaderCardOverviewEvaluationQEState();
}

class _HeaderCardOverviewEvaluationQEState extends State<HeaderCardOverviewEvaluationQE> {
