...
class InfoGeneralS extends StatefulWidget {
  const InfoGeneralS({Key? key}) : super(key: key);

  @override
  State<InfoGeneralS> createState() => _InfoGeneralSState();
}

class _InfoGeneralSState extends State<InfoGeneralS> {
