...
class ScreenGestionAuditQS extends StatefulWidget {
  const ScreenGestionAuditQS({super.key});

  @override
  State<ScreenGestionAuditQS> createState() => _ScreenGestionAuditQSState();
}

class _ScreenGestionAuditQSState extends State<ScreenGestionAuditQS> {
  ...
  Widget build(BuildContext context) {
    List<Widget> widget=[
      InfoGeneralQS(),PlanAuditPageQS(),CheckListQS(),BilanAuditQS(),
    ];
          ...
          children: [
            Row(
              ...
              children: [
                ...
                SizedBox(width: 5,),
                RichText(text:TextSpan(text:"Audit QS ",style: headerBoldStyle,children: [
