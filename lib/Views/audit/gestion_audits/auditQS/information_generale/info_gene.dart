...
class InfoGeneralQS extends StatefulWidget {
  const InfoGeneralQS({Key? key}) : super(key: key);

  @override
  State<InfoGeneralQS> createState() => _InfoGeneralQSState();
}

class _InfoGeneralQSState extends State<InfoGeneralQS> {
