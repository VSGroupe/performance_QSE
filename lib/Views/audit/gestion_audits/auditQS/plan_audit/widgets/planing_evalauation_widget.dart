...
class PlaningEvaluationQS extends StatefulWidget {
  final String date;
  const PlaningEvaluationQS({super.key, required this.date});

  @override
  State<PlaningEvaluationQS> createState() => _PlaningEvaluationQSState();
}

class _PlaningEvaluationQSState extends State<PlaningEvaluationQS> {
  @override
  Widget rowPlannig(){
    return Container(
