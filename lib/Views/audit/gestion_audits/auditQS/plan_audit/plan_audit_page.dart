...
class PlanAuditPageQS extends StatefulWidget {
  const PlanAuditPageQS({super.key});

  @override
  State<PlanAuditPageQS> createState() => _PlanAuditPageQSState();
}

class _PlanAuditPageQSState extends State<PlanAuditPageQS> {
              ...
              child: Container(
                  ...
                  child: VsScrollbar(
                    ...
                    child: ListView(
                      ...
                      controller: _scrollController,
                      children: [
                        PlaningEvaluationQS(date: "19/07/2023"),
                        PlaningEvaluationQS(date: "20/07/2023"),
                        PlaningEvaluationQS(date: "21/07/2023"),
                      ],
                    ),
                  )),
            )),
