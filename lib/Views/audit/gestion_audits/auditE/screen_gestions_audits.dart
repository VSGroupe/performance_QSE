...
class ScreenGestionAuditE extends StatefulWidget {
  const ScreenGestionAuditE({super.key});

  @override
  State<ScreenGestionAuditE> createState() => _ScreenGestionAuditEState();
}

class _ScreenGestionAuditEState extends State<ScreenGestionAuditE> {
  ...
  Widget build(BuildContext context) {
    List<Widget> widget=[
      InfoGeneralE(),PlanAuditPageE(),CheckListE(),BilanAuditE(),
    ];
          ...
          children: [
            Row(
              ...
              children: [
                ...
                SizedBox(width: 5,),
                RichText(text:TextSpan(text:"Audit Environnement [ E ] ",style: headerBoldStyle,children: [
                  TextSpan(text:"> AuditE N-2023-07-19",style:headerNormalStyle)
                ]))
