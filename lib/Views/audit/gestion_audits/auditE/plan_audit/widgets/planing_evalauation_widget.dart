...
class PlaningEvaluationE extends StatefulWidget {
  final String date;
  const PlaningEvaluationE({super.key, required this.date});

  @override
  State<PlaningEvaluationE> createState() => _PlaningEvaluationEState();
}

class _PlaningEvaluationEState extends State<PlaningEvaluationE> {
  @override
  Widget rowPlannig(){
    return Container(
