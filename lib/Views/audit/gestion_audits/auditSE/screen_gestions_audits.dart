...
class ScreenGestionAuditSE extends StatefulWidget {
  const ScreenGestionAuditSE({super.key});

  @override
  State<ScreenGestionAuditSE> createState() => _ScreenGestionAuditSEState();
}

class _ScreenGestionAuditSEState extends State<ScreenGestionAuditSE> {
  ...
  Widget build(BuildContext context) {
    List<Widget> widget=[
      InfoGeneralSE(),PlanAuditPageSE(),CheckListSE(),BilanAuditSE(),
    ];
          ...
          children: [
            Row(
              ...
              children: [
                ...
                SizedBox(width: 5,),
                RichText(text:TextSpan(text:"Audit SE ",style: headerBoldStyle,children: [
