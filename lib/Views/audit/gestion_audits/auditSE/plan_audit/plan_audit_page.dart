...
class PlanAuditPageSE extends StatefulWidget {
  const PlanAuditPageSE({super.key});

  @override
  State<PlanAuditPageSE> createState() => _PlanAuditPageSEState();
}

class _PlanAuditPageSEState extends State<PlanAuditPageSE> {
              ...
              child: Container(
                  ...
                  child: VsScrollbar(
                    ...
                    child: ListView(
                      ...
                      controller: _scrollController,
                      children: [
                        PlaningEvaluationSE(date: "19/07/2023"),
                        PlaningEvaluationSE(date: "20/07/2023"),
                        PlaningEvaluationSE(date: "21/07/2023"),
                      ],
                    ),
                  )),
            )),
