...
class PlaningEvaluationSE extends StatefulWidget {
  final String date;
  const PlaningEvaluationSE({super.key, required this.date});

  @override
  State<PlaningEvaluationSE> createState() => _PlaningEvaluationSEState();
}

class _PlaningEvaluationSEState extends State<PlaningEvaluationSE> {
  @override
  Widget rowPlannig(){
    return Container(
