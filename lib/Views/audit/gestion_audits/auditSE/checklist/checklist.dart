...
class CheckListSE extends StatefulWidget {
  const CheckListSE({super.key});

  @override
  State<CheckListSE> createState() => _CheckListSEState();
}

class _CheckListSEState extends State<CheckListSE> {
