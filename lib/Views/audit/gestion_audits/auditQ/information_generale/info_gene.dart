...
class InfoGeneralQ extends StatefulWidget {
  const InfoGeneralQ({Key? key}) : super(key: key);

  @override
  State<InfoGeneralQ> createState() => _InfoGeneralQState();
}

class _InfoGeneralQState extends State<InfoGeneralQ> {
