...
class ScreenGestionAuditQ extends StatefulWidget {
  const ScreenGestionAuditQ({super.key});

  @override
  State<ScreenGestionAuditQ> createState() => _ScreenGestionAuditQState();
}

class _ScreenGestionAuditQState extends State<ScreenGestionAuditQ> {
  ...
  Widget build(BuildContext context) {
    List<Widget> widget=[
      InfoGeneralQ(),PlanAuditPageQ(),CheckListQ(),BilanAuditQ(),
    ];
          ...
          children: [
            Row(
              ...
              children: [
                ...
                SizedBox(width: 5,),
                RichText(text:TextSpan(text:"Audit Qualité [ Q ] ",style: headerBoldStyle,children: [
