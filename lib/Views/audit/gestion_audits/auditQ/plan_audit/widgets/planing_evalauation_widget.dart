...
class PlaningEvaluationQ extends StatefulWidget {
  final String date;
  const PlaningEvaluationQ({super.key, required this.date});

  @override
  State<PlaningEvaluationQ> createState() => _PlaningEvaluationQState();
}

class _PlaningEvaluationQState extends State<PlaningEvaluationQ> {
  @override
  Widget rowPlannig(){
    return Container(
