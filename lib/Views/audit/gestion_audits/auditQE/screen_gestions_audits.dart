...
class ScreenGestionAuditQE extends StatefulWidget {
  const ScreenGestionAuditQE({super.key});

  @override
  State<ScreenGestionAuditQE> createState() => _ScreenGestionAuditQEState();
}

class _ScreenGestionAuditQEState extends State<ScreenGestionAuditQE> {
  ...
  Widget build(BuildContext context) {
    List<Widget> widget=[
      InfoGeneralQE(),PlanAuditPageQE(),CheckListQE(),BilanAuditQE(),
    ];
          ...
          children: [
            Row(
              ...
              children: [
                ...
                SizedBox(width: 5,),
                RichText(text:TextSpan(text:"Audit QE ",style: headerBoldStyle,children: [
