...
class PlaningEvaluationQE extends StatefulWidget {
  final String date;
  const PlaningEvaluationQE({super.key, required this.date});

  @override
  State<PlaningEvaluationQE> createState() => _PlaningEvaluationQEState();
}

class _PlaningEvaluationQEState extends State<PlaningEvaluationQE> {
  @override
  Widget rowPlannig(){
    return Container(
