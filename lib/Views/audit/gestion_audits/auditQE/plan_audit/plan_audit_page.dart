...
class PlanAuditPageQE extends StatefulWidget {
  const PlanAuditPageQE({super.key});

  @override
  State<PlanAuditPageQE> createState() => _PlanAuditPageQEState();
}

class _PlanAuditPageQEState extends State<PlanAuditPageQE> {
              ...
              child: Container(
                  ...
                  child: VsScrollbar(
                    ...
                    child: ListView(
                      ...
                      controller: _scrollController,
                      children: [
                        PlaningEvaluationQE(date: "19/07/2023"),
                        PlaningEvaluationQE(date: "20/07/2023"),
                        PlaningEvaluationQE(date: "21/07/2023"),
                      ],
                    ),
                  )),
            )),
