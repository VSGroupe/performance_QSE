...
class InfoGeneralQE extends StatefulWidget {
  const InfoGeneralQE({Key? key}) : super(key: key);

  @override
  State<InfoGeneralQE> createState() => _InfoGeneralQEState();
}

class _InfoGeneralQEState extends State<InfoGeneralQE> {
