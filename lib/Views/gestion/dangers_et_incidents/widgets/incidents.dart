          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 70.0), // Espacement entre le texte et les boutons
                Padding(
                  ...
                  child: FutureBuilder<List<Map<String, dynamic>>>(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        return const Center(child: Text('Aucun incident trouvé.'));
                      } else {
                                  ...
                                  title: Row(
                                    children: [
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: () => _showDeleteConfirmationDialog(incident['id_alea']),
                                      ),
                                    ],
                                  ),
                                ),
